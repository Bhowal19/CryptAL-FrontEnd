...
// import Presentation from 'pages/Presentation/components/explainflow'; // Update the import path as per your project structure
      ...
      >
        <Container>
          <Grid container item xs={12} lg={7} justifyContent="center" mx="auto">
            ...
            >
              CryptAl - Unleash the Power of Cryptography!{" "}
            </MKTypography>
            <MKTypography
              variant="body1"
              color="white"
              ...
              mt={1}
            >
              Compare the best encryption techniques tailored for your benefit! &amp;
            </MKTypography>
          </Grid>
        </Container>
      </MKBox>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} lg={5} ml="auto" sx={{ textAlign: { xs: "center", lg: "left" } }}>
                <MKTypography variant="h4" fontWeight="bold" mb={0.5}>
                  Thank you for using CryptAl!
                </MKTypography>
                <MKTypography variant="body1" color="text">
                  We hope your message is safe :)
                </MKTypography>
              </Grid>
              <Grid
                item
